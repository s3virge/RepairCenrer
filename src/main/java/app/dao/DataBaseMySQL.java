...
//            properties.put("characterEncoding","Cp1251");
     ...
     */
    public void create() {
        logger.trace("execute DataBaseMySQL.create()");
    ...
    public static int getId(String strTable, String strColumn, String strValue) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
            ...
            logger.debug("DataBaseMySQL.java: Облом c getId() -> " + lastError);
        }
    ...
    public static int getMaxId(String strTable) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
            ...
            lastError = e.getMessage();
            System.out.println( "DataBaseMySQL.java: Облом c getMaxId() -> " + lastError);
        }
