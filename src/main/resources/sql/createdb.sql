...
CREATE TABLE IF NOT EXISTS `repaircenter`.`name` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `repaircenter`.`patronymic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `repaircenter`.`patronymic` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `value_UNIQUE` (`value` ASC))
...
-- -----------------------------------------------------
-- Table `repaircenter`.`surname`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `repaircenter`.`surname` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `value_UNIQUE` (`value` ASC))
...
CREATE TABLE IF NOT EXISTS `repaircenter`.`owner` (
  ...
  CONSTRAINT `owner_name`
    FOREIGN KEY (`name_id`)
    REFERENCES `repaircenter`.`name` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `owner_patronymic`
    FOREIGN KEY (`patronymic_id`)
    REFERENCES `repaircenter`.`patronymic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `owner_surname`
    FOREIGN KEY (`surname_id`)
    REFERENCES `repaircenter`.`surname` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
START TRANSACTION;
USE `repaircenter`;
INSERT INTO `repaircenter`.`user_group` (`id`, `value`) VALUES (1, 'administrator');
INSERT INTO `repaircenter`.`user_group` (`id`, `value`) VALUES (2, 'manager');
INSERT INTO `repaircenter`.`user_group` (`id`, `value`) VALUES (3, 'master');
INSERT INTO `repaircenter`.`user_group` (`id`, `value`) VALUES (4, 'acceptor');
