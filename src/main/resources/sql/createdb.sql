...
INSERT INTO `repaircenter`.`user` (`id`, `login`, `password`, `user_group`, `surname`, `name`, `patronymic`, `phone_number`, `email`) VALUES (2, 's3virge', md5('IloveCPP78'), 3, 'Кобзарь', 'Виталий', 'Владимирович', NULL, NULL);
...
INSERT INTO `repaircenter`.`status` (`id`, `value`) VALUES (5, 'Готово');
INSERT INTO `repaircenter`.`status` (`id`, `value`) VALUES (6, 'Выдано');
